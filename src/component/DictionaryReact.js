            ...
            <div key={word.link}>
              <div className="result_word">
                <button className="add_btn"
                  onClick={() => handleAddWord(word)}></button>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href={word.link}
                  target="_blank"
                  rel="noreferrer"
                  dangerouslySetInnerHTML={{ __html: word.title }}></a>
              </div>
            ...
            <div key={word.link}>
              <a href={word.link}
                ...
                <div className="word_title"
                      dangerouslySetInnerHTML={{ __html: word.title }}></div>
              </a>
              <button className="dlt_btn"
                      onClick={() => handleDeleteWord(word)}></button>
            </div>
          ))}
